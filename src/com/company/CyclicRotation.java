...
public class CyclicRotation {
    ...
    public int[] solution(int[] data, int K) {
        if (data == null)
            return null;
        for (int i = 0; i < K; i++) {
            int tempArrayElement = data[data.length - 1];
...
/**
 *  link to codewars solution:
 *  https://github.com/bromazepam/codewars/blob/master/src/com/company/java/kyu6/RotateArray.java
 */
